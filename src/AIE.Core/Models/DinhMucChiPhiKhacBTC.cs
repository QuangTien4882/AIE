...
namespace AIE.Core.Models
{
    ...
    public static class DinhMucChiPhiKhacBTC
    {
        ...
        public static readonly decimal[] TiLeThamDinhDuAn = new decimal[] { 0.0190m, 0.0170m, 0.0150m, 0.0125m, 0.0100m, 0.0075m, 0.0047m, 0.0025m, 0.0020m, 0.0010m };
